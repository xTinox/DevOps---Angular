...
export declare class MouseleaveBinderDirective extends InteractoBinderDirective<HTMLElement, PartialPointBinder> {
    private bindings;
    private readonly mouseleaveBinder;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<MouseleaveBinderDirective, [{ optional: true; host: true; }, null, null, null, null]>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<MouseleaveBinderDirective, "[ioMouseleave]", never, { "bubbling": "bubbling"; "ioMouseleave": "ioMouseleave"; }, { "mouseleaveBinder": "mouseleaveBinder"; }, never, never, false>;
}
