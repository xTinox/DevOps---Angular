...
export declare class KeyupBinderDirective extends InteractoBinderDirective<HTMLElement, PartialKeyBinder> {
    private bindings;
    private readonly keyupBinder;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<KeyupBinderDirective, [{ optional: true; host: true; }, null, null, null, null]>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<KeyupBinderDirective, "[ioKeyup]", never, { "modifierAccepted": "modifierAccepted"; "ioKeyup": "ioKeyup"; }, { "keyupBinder": "keyupBinder"; }, never, never, false>;
}
