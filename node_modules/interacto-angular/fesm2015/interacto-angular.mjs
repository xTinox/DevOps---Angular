...
class MatSelectFSM extends FSMImpl {
    constructor(logger, dataHandler) {
        ...
        new MatSelectChangeTransition(this.initState, this.addTerminalState("changed"), (evt) => {
            var _a;
            (_a = this.dataHandler) === null || _a === void 0 ? void 0 : _a.selectionChanged(evt.change);
        });
    }
}
...
class InteractoBinderDirective {
    ...
    callBinder(fn) {
        ...
        (_a = this.changeDetectorRef) === null || _a === void 0 ? void 0 : _a.detectChanges();
    ...
    ngAfterContentInit() {
        var _a;
        if (!this.inputSet) {
            (_a = this.getOutputEvent()) === null || _a === void 0 ? void 0 : _a.emit(this.completePartialBinder());
        }
    }
    ngOnDestroy() {
        var _a, _b;
        (_a = this.binding) === null || _a === void 0 ? void 0 : _a.forEach(b => b.uninstallBinding());
        (_b = this.getOutputEvent()) === null || _b === void 0 ? void 0 : _b.complete();
    }
...
class LinearHistoryComponent {
    ...
    ngAfterViewInit() {
        this.bindings.buttonBinder()
            ...
            .toProduce(i => { var _a, _b; return new UndoNTimes(this.undoHistory, parseInt((_b = (_a = i.widget) === null || _a === void 0 ? void 0 : _a.getAttribute("data-index")) !== null && _b !== void 0 ? _b : "-1", 0)); })
            .bind();
        this.bindings.buttonBinder()
            .onDynamic(this.redoButtonContainer)
            .toProduce(i => { var _a, _b; return new RedoNTimes(this.undoHistory, parseInt((_b = (_a = i.widget) === null || _a === void 0 ? void 0 : _a.getAttribute("data-index")) !== null && _b !== void 0 ? _b : "-1", 0)); })
            .bind();
    }
    undoButtonSnapshot(command, button) {
        ...
        if (snapshot instanceof SVGElement) {
            (_a = button.querySelectorAll('div')[0]) === null || _a === void 0 ? void 0 : _a.remove();
            ...
            (_b = button.querySelectorAll('div')[0]) === null || _b === void 0 ? void 0 : _b.remove();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: ClickBinderDirective, decorators: [{
        ...
        return [{ type: OnDynamicDirective, decorators: [{
                        type: Optional
                    }, {
                        type: Host
                    }] }, { type: i0.ElementRef }, { type: i0.ViewContainerRef }, { type: i2.Bindings }];
    }, propDecorators: { clickBinder: [{
                type: Output
            }], ioClick: [{
                type: Input
            }] } });
...
class TreeHistoryComponent {
    ...
    createHtmlTag(snapshot, div, svg) {
        var _a;
        (_a = div.querySelectorAll('div')[0]) === null || _a === void 0 ? void 0 : _a.remove();
        const size = `${this.svgIconSize}px`;
    ...
    undoButtonSnapshot(node, div) {
        ...
        if ((node === null || node === void 0 ? void 0 : node.id) === this.history.currentNode.id) {
            div.scrollIntoView();
        }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: ClicksBinderDirective, decorators: [{
        ...
        return [{ type: OnDynamicDirective, decorators: [{
                        ...
                        type: Host
                    }] }, { type: i0.ElementRef }, { type: i0.ViewContainerRef }, { type: i0.ChangeDetectorRef }, { type: i2.Bindings }];
    }, propDecorators: { clicksBinder: [{
                type: Output
            }], count: [{
                type: Input
            }], ioClicks: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: DoubleClickBinderDirective, decorators: [{
    ...
    }, propDecorators: { dbleclickBinder: [{
                type: Output
            }], ioDoubleClick: [{
                type: Input
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: LongTouchBinderDirective, decorators: [{
    ...
    }, propDecorators: { longTouchBinder: [{
                type: Output
            }], duration: [{
                type: Input
            }], ioLongTouch: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: LongMousedownBinderDirective, decorators: [{
    ...
    }, propDecorators: { longMousedownBinder: [{
                type: Output
            }], duration: [{
                type: Input
            }], ioLongMousedown: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: MultiTouchBinderDirective, decorators: [{
    ...
    }, propDecorators: { multiTouchBinder: [{
                type: Output
            }], nbTouches: [{
                type: Input
            }], ioMultiTouch: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: MousedownBinderDirective, decorators: [{
    ...
    }, propDecorators: { mousedownBinder: [{
                type: Output
            }], ioMousedown: [{
                type: Input
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: MousemoveBinderDirective, decorators: [{
    ...
    }, propDecorators: { mousemoveBinder: [{
                type: Output
            }], ioMousemove: [{
                type: Input
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: MouseenterBinderDirective, decorators: [{
    ...
    }, propDecorators: { mouseenterBinder: [{
                type: Output
            }], bubbling: [{
                type: Input
            }], ioMouseenter: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: MouseleaveBinderDirective, decorators: [{
    ...
    }, propDecorators: { mouseleaveBinder: [{
                type: Output
            }], bubbling: [{
                type: Input
            }], ioMouseleave: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: TextInputBinderDirective, decorators: [{
    ...
    }, propDecorators: { textinputBinder: [{
                type: Output
            }], ioTextinput: [{
                type: Input
            }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.0.4", ngImport: i0, type: MatSelectBinderDirective, decorators: [{
        ...
        return [{ type: OnDynamicDirective, decorators: [{
                        ...
                        type: Host
                    }] }, { type: i0.ViewContainerRef }, { type: AngularBindings }, { type: i3.MatSelect }];
    }, propDecorators: { matSelectBinder: [{
                type: Output
            }], ioMatSelect: [{
                type: Input
            }] } });
